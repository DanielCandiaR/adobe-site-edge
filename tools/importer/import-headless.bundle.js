...
var CustomImportScript = (() => {
  ...
  // tools/importer/import-headless.js
  var import_headless_exports = {};
  __export(import_headless_exports, {
    default: () => import_headless_default
  });
  ...
  // tools/importer/parsers/timeline-cards.js
  function parse3(element, { document: document2 }) {
    ...
    const block = WebImporter.Blocks.createBlock(document2, { name: "timeline-cards", cells });
    element.replaceWith(block);
  }

  // tools/importer/parsers/browser-frame.js
  function parse4(element, { document: document2 }) {
    ...
    const block = WebImporter.Blocks.createBlock(document2, { name: "browser-frame", cells });
    element.replaceWith(block);
  }

  // tools/importer/parsers/text-list.js
  function parse5(element, { document: document2 }) {
    ...
    const block = WebImporter.Blocks.createBlock(document2, { name: "text-list", cells });
    element.replaceWith(block);
  }
  ...
  var parsers = {
    "hero-partner": parse,
    "title-page": parse2,
    "timeline-cards": parse3,
    "browser-frame": parse4,
    "text-list": parse5
  };
  var PAGE_TEMPLATE = {
    name: "headless",
  ...
  return __toCommonJS(import_headless_exports);
})();
